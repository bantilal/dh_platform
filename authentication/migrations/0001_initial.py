    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('public', 'Public Visitor'), ('subscriber', 'Subscriber'), ('admin', 'Administrator')], default='public', max_length=20)),
                ...
                ('charity_percent', models.DecimalField(decimal_places=2, default=10.0, max_digits=5)),
